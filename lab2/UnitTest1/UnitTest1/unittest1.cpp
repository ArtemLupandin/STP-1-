...
{		
	...
	public:
		...
		TEST_METHOD(TestMethod15)
		{
			...
			TComplex a(1.0, 3.0);
			a = a.Step(2);
			Assert::AreEqual(a.getReal(), float(-8), float(0.1));
			Assert::AreEqual(a.getMnim(), float(6), float(0.1));
		}
		TEST_METHOD(TestMethod16)
		{
			...
			TComplex a(1.0, 3.0);
			a = a.Step(3);
			Assert::AreEqual(a.getReal(), float(-26), float(0.1));
			Assert::AreEqual(a.getMnim(), float(-18), float(0.1));
		}
	};
}